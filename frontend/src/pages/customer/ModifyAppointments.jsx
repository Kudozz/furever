...
const ModifyAppointments = () => {
  ...
  const handleSave = async (id) => {
    try {
      await axios.patch(`${import.meta.env.VITE_API_URL}/api/appointments/${id}/status`, form);
  ...
  const handleCancel = async (id) => {
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/api/appointments/cancel/${id}`);
  ...
  return (
    <VStack spacing={6} mt={10} maxW="800px" mx="auto">
      <Heading size="2xl" textAlign="center" mb={6} color="gray.700">Modify Appointments</Heading>
